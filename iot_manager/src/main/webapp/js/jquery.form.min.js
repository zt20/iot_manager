...
(function (e) {
    ...
    e.fn.ajaxSubmit = function (n) {
        ...
        function N(t) {
            ...
            n.data = null;
            var u = e.extend(!0, {}, e.ajaxSettings, n, {
                contentType: !1,
                processData: !1,
                cache: !1,
                type: r || "POST"
        ...
        function C(t) {
            ...
            function k() {
                ...
                !f.skipEncodingOverride && (!r || /post/i.test(r)) && u.attr({
            ...
            var S = 1, x = 2, N = e("meta[name=csrf-token]").attr("content"),
        ...
        var m = e('input[type=file]:enabled[value!=""]', this), g = m.length > 0, y = "multipart/form-data",
            b = u.attr("enctype") == y || u.attr("encoding") == y, w = t.fileapi && t.formdata;
        i("fileAPI :" + w);
        var E = (g || b) && !w, S;
    ...
    e.fn.formToArray = function (n, r) {
        ...
        for (u = 0, h = o.length; u < h; u++) {
            ...
            if (l && l.constructor == Array) {
                ...
                r && r.push(c);
                var d = c.files;
                if (d.length) for (a = 0; a < d.length; a++) i.push({
                    name: f,
                    value: d[a],
                    type: c.type
                }); else i.push({name: f, value: "", type: c.type})
